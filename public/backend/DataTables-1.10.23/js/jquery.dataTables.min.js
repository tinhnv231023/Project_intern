...
(function(k) {
    ...
    var u = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) aa(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    f = r.asStripeClasses;
                    var H = p.children("tbody").find("tr").eq(0); - 1 !== k.inArray(!0, k.map(f, function(C, B) { return H.hasClass(C) })) && (k("tbody tr", this).removeClass(f.join(" ")), r.asDestroyStripes = f.slice());
                    f = [];
    ...
    J("columns().visible()", "column().visible()", function(a, b) {
        ...
        a !== q && this.iterator("table", function(e) {
            ...
            Qa(e);
            c.iterator("column",
                function(f, g) { I(f, null, "column-visibility", [f, g, a, b]) });
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<b>Không có dữ liệu</b>",
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "<b> Hiển thị _MENU_ dòng </b>",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: "<b>Tìm kiếm:</b>",
            sSearchPlaceholder: "Tìm kiếm .....",
            sUrl: "",
            sZeroRecords: "<b>Không tìm thấy kêt quả</b>"
        },
    ...
    k.extend(!0, u.ext.renderer, {
        header: {
            _: function(a, b, c, d) { k(a.nTable).on("order.dt.DT", function(e, f, g, h) { a === f && (e = c.idx, b.removeClass(c.sSortingClass + " " + d.sSortAsc + " " + d.sSortDesc).addClass("asc" == h[e] ? d.sSortAsc : "desc" == h[e] ? d.sSortDesc : c.sSortingClass)) }) },
